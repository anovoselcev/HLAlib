 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Mar 24 19:04:30 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ConverterNew
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void ConverterNew_Start_wrapper(void);
extern void ConverterNew_Outputs_wrapper(const real_T *X,
			real_T *Y);
extern void ConverterNew_Terminate_wrapper(void);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    ConverterNew_Outputs_wrapper(X, Y);
