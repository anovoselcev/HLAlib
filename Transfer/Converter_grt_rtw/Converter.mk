...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Converter
...
PRODUCT_NAME              = Converter
MAKEFILE                  = Converter.mk
MATLAB_ROOT               = /home/k-110-04/Matlab
MATLAB_BIN                = /home/k-110-04/Matlab/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/glnxa64
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/k-110-04/QtWork/HLA/HLA-Simulink/Transfer
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C++
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Converter
...
DEFINES_STANDARD = -DMODEL=Converter -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
%.o : /home/k-110-04/QtWork/HLA/UPIM/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /home/k-110-04/QtWork/HLA/UPIM/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Converter_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Converter_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Converter.o : $(START_DIR)/Converter_grt_rtw/Converter.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
UPIM.o : /home/k-110-04/QtWork/HLA/UPIM/UPIM.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Transfer.o : $(START_DIR)/Transfer.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
